...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference("Invitation.count") do
      post invitations_url, params: { invitation: { status: @invitation.status, therapist_id: @invitation.therapist_id, user_id: @invitation.user_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { status: @invitation.status, therapist_id: @invitation.therapist_id, user_id: @invitation.user_id } }
