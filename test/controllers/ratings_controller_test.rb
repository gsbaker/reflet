...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference("Rating.count") do
      post ratings_url, params: { rating: { need_id: @rating.need_id, report_id: @rating.report_id } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { need_id: @rating.need_id, report_id: @rating.report_id } }
